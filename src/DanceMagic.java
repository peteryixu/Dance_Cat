...
public class DanceMagic {
    ...
    private String getMoveLocation(int sequence) {
        return String.format("resources\\cat-0%s%d.txt", (sequence < 10 ? "0" : ""), sequence);
    }
    ...
    private void printWin() {
        printMessage("resources\\cat-win.txt", "6");
    }

    private void printLose() {
        printMessage("resources\\cat-lose.txt", "3");
    }

    private void printTie() {
        printMessage("resources\\cat-tie.txt", "7");
    }

    private void printError() {
        printMessage("resources\\cat-error.txt", "1");
    }
